...
public class SettingsEN extends javax.swing.JFrame {
    ...
    private void FillAll(){
        ...
        try{
             String sql = "SELECT * FROM spr_settingsen";
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Разрешить преподователям выставлять оценки с ");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(checkAllowPoints, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(jLabel3)
                        .addComponent(fromEdit, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
    ...
    private void btnAcceptSettingsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptSettingsActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE spr_settingsen SET A_NAMES='"+value1+"',A_NAMEL='"+value2+"',A_ADRES='"+value3
            +"',A_PHONE='"+value4
            +"',A_PRIM='"+value22
            +"',A_FAX='"+value5
            +"',A_OKPO='"+value6
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SettingsEN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SettingsEN().setVisible(true);
            }
        });
    }
